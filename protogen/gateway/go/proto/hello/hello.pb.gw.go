...
import (
	...
	extHello "github.com/yudistirarivaldi/grpc-proto/protogen/go/hello"
...
func request_HelloService_SayManyHelloss_0(ctx context.Context, marshaler runtime.Marshaler, client extHello.HelloServiceClient, req *http.Request, pathParams map[string]string) (extHello.HelloService_SayManyHellossClient, runtime.ServerMetadata, error) {
	var (
		protoReq extHello.HelloRequest
		metadata runtime.ServerMetadata
	)
	...
	stream, err := client.SayManyHelloss(ctx, &protoReq)
	if err != nil {
...
func RegisterHelloServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extHello.HelloServiceServer) error {
	...
	mux.Handle(http.MethodPost, pattern_HelloService_SayManyHelloss_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterHelloServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extHello.HelloServiceClient) error {
	...
	mux.Handle(http.MethodPost, pattern_HelloService_SayManyHelloss_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/hello.HelloService/SayManyHelloss", runtime.WithHTTPPathPattern("/hello.HelloService/SayManyHelloss"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_HelloService_SayManyHelloss_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		}
		forward_HelloService_SayManyHelloss_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}
...
var (
	...
	pattern_HelloService_SayManyHelloss_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"hello.HelloService", "SayManyHelloss"}, ""))
)

var (
	forward_HelloService_SayHello_0       = runtime.ForwardResponseMessage
	forward_HelloService_SayManyHelloss_0 = runtime.ForwardResponseStream
)
