...
const (
	...
	HelloService_SayHelloToEveryon_FullMethodName = "/hello.HelloService/SayHelloToEveryon"
)
...
type HelloServiceClient interface {
	...
	SayHelloToEveryon(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *helloServiceClient) SayHelloToEveryon(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[1], HelloService_SayHelloToEveryon_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HelloRequest, HelloResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloToEveryonClient = grpc.ClientStreamingClient[HelloRequest, HelloResponse]
...
type HelloServiceServer interface {
	...
	SayHelloToEveryon(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedHelloServiceServer) SayHelloToEveryon(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloToEveryon not implemented")
}
...
func _HelloService_SayHelloToEveryon_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayHelloToEveryon(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayHelloToEveryonServer = grpc.ClientStreamingServer[HelloRequest, HelloResponse]
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloToEveryon",
			Handler:       _HelloService_SayHelloToEveryon_Handler,
			ClientStreams: true,
		},
	},
